import {View, StyleSheet, Text, ScrollView, SafeAreaView, TouchableOpacity, TextInput} from 'react-native';
...
const PasswordSchema = Yup.object().shape({
    ...
    .max(12, 'Should be less than 12 characters')
    .required('Length is required')
})

export default function PG_App() {
    ...
    const generatePasswordString = (passwordLength:number)=>{
      ...
      const lowerCasechar = 'qwertyuioplkjhgfdsazxcvbnm';
